...
public partial class BA02Form : Form
{
    ...
    public BA02Form()
    {
        ...
        btnNew.ImageOffset = new Point(14, 0);
        btnSave.ImageOffset = new Point(14, 0);
        btnUpd.ImageOffset = new Point(14, 0);
        btnDel.ImageOffset = new Point(14, 0);
        btnSearch.ImageOffset = new Point(14, 0);
        btnClose.ImageOffset = new Point(14, 0);
        btnNew.TextOffset = new Point(18, 0);
        btnSave.TextOffset = new Point(18, 0);
        btnUpd.TextOffset = new Point(18, 0);
        btnDel.TextOffset = new Point(18, 0);
