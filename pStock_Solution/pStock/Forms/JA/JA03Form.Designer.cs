...
partial class JA03Form
{
    ...
    private void InitializeComponent()
    {
        ...
        this.edtCvcod = new Guna2TextBox();
        ...
        this.lblCvcod.AutoSize = false;
        this.lblCvcod.TextAlign = ContentAlignment.MiddleLeft;
        this.lblCvcod.Width = 80; this.lblCvcod.Height = 20;
        this.lblCvcod.Left = this.btnMonthUp.Right + 24; this.lblCvcod.Top = 60;
        this.edtCvcod.Left = this.lblCvcod.Right + 2; this.edtCvcod.Top = 54; this.edtCvcod.Width = 100;
        this.edtCvcod.KeyDown += EdtCvcod_KeyDown;
        this.dspName.Left = this.edtCvcod.Right + 8; this.dspName.Top = 54; this.dspName.Width = 220;
        ...
        this.filterPanel.Controls.AddRange(new Control[]
        {
            ...
            this.lblCvcod, this.edtCvcod, this.dspName
        });
        //
        // filterAreaPanel
        //
        ...
        //
        this.gridTitleLabel.Text = "일자별 집계";
